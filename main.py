...
tile_image = {'wall': pygame.image.load('data/box.png'),
...
def start_screen():
    intro_text = ["Перемещение героя", '',
                  "Герой двигается",
                  "Карта на месте"]
    fon = pygame.transform.scale(pygame.image.load('data/fon.jpg'), size)
    screen.blit((fon), (0, 0))
